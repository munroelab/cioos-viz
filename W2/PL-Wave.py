...
from bokeh.models import DatetimeTickFormatter, ColumnDataSource, BoxAnnotation
...
e.response = "csv"
e.dataset_id = "SMA_MouthofPlacentiaBayBuoy"
e.constraints = {
...
fig1.yaxis.axis_label = "metres"
fig1.yaxis.axis_label_text_font_size = "15pt"
fig1.outline_line_color=None
fig1.line(time, df['wave_ht_max (m)'], line_width=5, color=single_color,
          legend_label='Max Wave Height')
