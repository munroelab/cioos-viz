...
maxdata = data.resample('0.5D').max()
...
p.line(data.index, maxdata['Temperature (degrees Celsius)'], line_width = 2, color='red')
p.line(data.index, mindata['Temperature (degrees Celsius)'],line_width = 2, color='blue')
show(p)
